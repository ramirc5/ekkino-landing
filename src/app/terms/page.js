    ...
    <>
      <div className="bg-white text-[#2E2E2F]">
        <div className="flex flex-col gap-[10px] w-[90%] mx-auto py-[20px] text-[16px]">
          ...
          <p>
            Website refers to Ekkino, accessible from{" "}
            <a href="https://ekkino.com">https://ekkino.com</a>
          </p>
          <p>
          ...
          <h1 className="font-sans font-semibold text-[24px]">
            "AS IS" and "AS AVAILABLE" Disclaimer of Liability{" "}
          </h1>
          <p>
          ...
          <p>
            By email: <a href="mailto:info@ekkino.com">info@ekkino.com</a>
          </p>
        </div>
      </div>
      <Footer />
